...
*{color: red}Note:* Radio buttons and checkboxes have their layout direction automatically set to vertical by default.  But this can be easily changed in the same manner by adjusting the layout property so they flow horizontally.
