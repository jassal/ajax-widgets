...
pre(small-format xml-format). <xs:element name="Name">
  <xs:complexType>
    <xs:sequence>
...
The above XSD snippet will generate the following form.
...
You can download the XSD "here (Name.xsd)":files/Name.xsd.
...
*{color: red}Note:* If you add or remove fields to the form or renamed fields, then you will need to make changes to the mapping file manually.  Currently Intalio|Ajax doesn't modify the mapping file automatically when the form is automatically created from a schema.
