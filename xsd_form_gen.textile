...
The above XSD snippet will generate the following form.  The @<annotation>@ elements are optional and is used to render the form label.  As you can see the rest of the schema is typical.  You can download this XSD "here (Name.xsd)":files/Name.xsd.
